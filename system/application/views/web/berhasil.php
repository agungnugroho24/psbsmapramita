...
<div style="height:80px;">
	<img src="<?php echo base_url()."system/application/views/web/images/logopramita.png" ?>" style="width:80px;" align="left" />
	<div style="text-align:center;">
		...
		Silahkan <a href="../daftar/5" ><strong><font color="red">login</font></strong></a> dengan menggunakan Nomor Pendaftaran dan password anda. <br/>
...
Silahkan <a href="" onclick="window.print()"><strong><font color="red">cetak</font></strong></a>. Data ini Sebagai Bukti Pendaftaran.</p>
</div>
</div>
</form>