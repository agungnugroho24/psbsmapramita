...
session_start();
include 'koneksi.php';
    $query = mysql_query("select * from tb_psb_data where idpsb=5");
	$no = 1;
            ...
            <table cellpadding="0" cellspacing="0" border="1" class="table" id="example" style="width:1200px:">
								    ...
								    <tr style="width:1200px:">
										...
										<tbody>
											...
											<?php
											$subject_query = mysql_query("select * from tb_psb_data where idpsb=5")or die(mysql_error());
									...
									<td align="center"><?php if($row["idpsb"]==5){echo "SMA";}?></td>
										</tr>
