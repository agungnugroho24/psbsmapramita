                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <div style="overflow:hidden">
                            <img src="<?php echo base_url()."assets/images/logopramita.png" ?>" style="width:100px;" align="left" />
                            <div align="center">
                                <h1 style="margin:0px;padding:0px;">PENDAFTARAN SISWA/I BARU</h1>
                                <h5 style="margin:0px;padding:0px;"><b>SMA Pramita Tangerang</b></h5>
                                JL. Kampus Pramita, Binong, Curug, Tangerang 15810<br/>
                                No. Tlp : (021) 5980576, Email : smapramita.2011@gmail.com, Fax : 021-5980576
                        ...
                        <table class="table table-hover" style="font-size:16px;">
                            <tr>
                                <td colspan="3" style="background:#ee6666;color:#fff;font-weight:bold;"> Data Siswa</td>
                            </tr>
                            <tr>
